...
import { computeDailyMicronutrients, VITAMIN_LABELS, MINERAL_LABELS } from '../utils/micronutrients';
...
export function MicronutrientsModal({ visible, onClose, entries }: Props) {
  const { colors, radius } = useTheme();

  const analysis = useMemo(() => computeDailyMicronutrients(entries), [entries]);
